					...
					<div class="row">
						<div class="col-md-2">
							<div class="card text-center">
								...
								<div class="card-body">
									<div id="status_sync_employees">
										<i class="far fa-frown fa-2x fail"></i>
									</div>
									<div id="show_sync_employees"><hr></div>
									<label class="switch">
										<input type="checkbox" id="btn_sync_employees">
										<span class="slider round"></span>
									</label>
									<input class="form-control form-control-sm" id="input_sync_employees" placeholder="ms">
								</div>
							</div>
						</div>
						<div class="col-md-2">
							<div class="card text-center">
								<div class="card-header">
									Sync Employees Auth0
								</div>
								<div class="card-body">
									<div id="status_sync_employees_auth0">
										<i class="far fa-frown fa-2x fail"></i>
									</div>
									<div id="show_sync_employees_auth0"></div>
									<hr>
									<label class="switch">
										<input type="checkbox" id="btn_sync_employees_auth0">
										<span class="slider round"></span>
									</label>
									<input class="form-control form-control-sm" id="input_sync_employees_auth0" placeholder="ms">
									<div id="show"></div>
								</div>
							</div>
						</div>
						<div class="col-md-2">
							<div class="card text-center">
								<div class="card-header">
									Sync Employees Login
								</div>
								<div class="card-body">
									<div id="status_sync_employees_login">
										<i class="far fa-frown fa-2x fail"></i>
									</div>
									<div id="show_sync_employees_login">
										<hr>
									</div>
									<label class="switch">
										<input type="checkbox" id="btn_sync_employees_login">
										<span class="slider round"></span>
									</label>
									<input class="form-control form-control-sm" id="input_sync_employees_login" placeholder="ms">
								</div>
							</div>
						</div>
					</div>
